...
const initialCategories = [
  {
    ...
    items: [
      { id: "1-1", title: "Apex Steel Works", contact: "John Doe", email: "john@apexsteel.com", phone: "+1 555-0123", status: "Approved", criticality: "High", lastAudit: "2023-11-15", highlighted: true, approved: true, paused: false },
      { id: "1-2", title: "Global Plastics Inc.", contact: "Jane Smith", email: "jane@globalplastics.com", phone: "+1 555-0456", status: "Probation", criticality: "Medium", lastAudit: "2024-01-20", highlighted: false, approved: true, paused: false },
    ]
  },
  {
    id: "2",
    ...
    items: [
      { id: "2-1", title: "SecureIT Solutions", contact: "Mike Johnson", email: "support@secureit.com", phone: "+1 555-0789", status: "Approved", criticality: "High", lastAudit: "2023-10-05", highlighted: true, approved: true, paused: false },
    ]
  },
]
  ...
  const addItemToCategory = (categoryId: string) => {
    if (newItemData.title.trim()) {
      const newItem = {
        ...
        contact: newItemData.contact.trim(),
        email: newItemData.email.trim(),
        phone: newItemData.phone.trim(),
        status: newItemData.status,
        criticality: newItemData.criticality,
        lastAudit: "N/A",
        highlighted: false,
        approved: false,
        paused: false
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: COLORS.textSecondary }}>
                Manage approved vendor list (AVL) and supplier performance
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex gap-3">
              <input
                ...
                placeholder="Enter category name (e.g. Logistics Partners)..."
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="px-3 py-1 rounded-full text-sm font-medium bg-white bg-opacity-20">
                      {category.items.length} suppliers
                    </span>
                  </div>
                  ...
                  <div className="p-5">
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={newItemData.contact}
                              onChange={(e) => setNewItemData(prev => ({ ...prev, contact: e.target.value }))}
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => setNewItemData(prev => ({ ...prev, criticality: e.target.value }))}
                              className="w-full px-4 py-2.5 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500"
                              style={{ borderColor: COLORS.border }}
                            >
                    ...
                    {category.items.length === 0 ? (
                      <div className="text-center py-12">
                        <Truck className="w-12 h-12 mx-auto mb-3" style={{ color: COLORS.textLight }} />
                        <p className="font-medium" style={{ color: COLORS.textSecondary }}>No suppliers in this category</p>
                      </div>
                    ) : (
                        ...
                        {category.items.map((item) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 ml-4">
                              ...
                              <div className="flex items-center gap-1">
                                <Link href={`/suppliers/${item.id}/edit`}><button className="p-2 rounded-lg hover:scale-105" style={{ background: "#DBEAFE", color: "#1E40AF" }}><Edit className="w-4 h-4" /></button></Link>
