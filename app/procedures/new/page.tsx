  ...
  useEffect(() => {
    const loadCategories = async () => {
      try {
        ...
        const response = await fetch("/api/categories?type=procedure", {
        ...
        console.error("Error loading procedure categories:", error)
      } finally {
              ...
              <div>
                ...
                >
                  {categoriesLoading ? (
                    ...
                    <option value="">No procedure categories found</option>
                  ) : (
                    categories.map((cat) => (
