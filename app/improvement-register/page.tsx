...
const initialCategories = [
  {
    ...
    items: [
      { id: "1-1", title: "Incorrect Packaging Label", source: "Customer Complaint", date: "2024-03-10", status: "Open", assignee: "Quality Manager", highlighted: true, approved: true, paused: false },
      { id: "1-2", title: "Failed Calibration Check", source: "Internal Audit", date: "2024-02-28", status: "Closed", assignee: "Maintenance Lead", highlighted: false, approved: true, paused: false },
    ]
  },
  {
    id: "2",
    ...
    items: [
      { id: "2-1", title: "Digitize Training Records", source: "Employee Suggestion", date: "2024-04-05", status: "In Progress", assignee: "HR Manager", highlighted: true, approved: true, paused: false },
    ]
  },
]
  ...
  const addItemToCategory = (categoryId: string) => {
    if (newItemData.title.trim()) {
      const newItem = {
        ...
        assignee: newItemData.assignee.trim() || "Unassigned",
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: COLORS.textSecondary }}>
                Track Non-Conformances (NCR) & Opportunities for Improvement (OFI)
              </p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <Link href="/improvement-register/new">
              <button
          ...
          >
            ...
            <div className="flex gap-3">
              <input
                ...
                placeholder="Enter category name (e.g. Supplier Issues)..."
                  ...
                  <div className="p-5">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <input
                              ...
                              placeholder="e.g. Packaging defect on line 3"
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setNewItemData(prev => ({ ...prev, assignee: e.target.value }))}
                              placeholder="e.g. QA Dept"
                              className="w-full px-4 py-2.5 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500"
                              style={{ borderColor: COLORS.border }}
                            />
                          </div>
                    ...
                    {sortedItems.length === 0 ? (
                      <div className="text-center py-12">
                        <TrendingUp className="w-12 h-12 mx-auto mb-3" style={{ color: COLORS.textLight }} />
                        <p className="font-medium" style={{ color: COLORS.textSecondary }}>No improvement records in this category</p>
                      </div>
                    ) : (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div className="flex justify-between items-start">
                                <Link
                                  href={`/improvement-register/${item.id}`}
                              ...
                              <div className="flex gap-6 text-sm mt-2" style={{ color: COLORS.textSecondary }}>
                                <div className="flex items-center gap-1">
                            ...
                            <div className="flex items-center gap-1.5 ml-4">
                              ...
                              <div className="flex items-center gap-1">
                                <Link href={`/improvement-register/${item.id}/edit`}><button className="p-2 rounded-lg hover:scale-105" style={{ background: "#DBEAFE", color: "#1E40AF" }}><Edit className="w-4 h-4" /></button></Link>
