...
export default function NewImprovementPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // TODO: Implement API call to create improvement record
    console.log({
      title,
      category,
      source,
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  <option value="1">Non-Conformance Reports (NCR)</option>
                  <option value="2">Opportunities for Improvement (OFI)</option>
                  <option value="3">Customer Complaints</option>
                  <option value="4">Supplier Issues</option>
                </select>
              </div>
