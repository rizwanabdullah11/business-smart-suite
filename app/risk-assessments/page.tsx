...
const initialCategories = [
  {
    ...
    title: "Health & Safety",
    assessments: [
      { id: "1-1", title: "Office Ergonomics Assessment", version: "v2.0", issueDate: "2024-01-10", area: "Office", riskLevel: "Low", highlighted: true, approved: true, paused: false },
      { id: "1-2", title: "Warehouse Forklift Operations", version: "v1.5", issueDate: "2024-02-15", area: "Warehouse", riskLevel: "High", highlighted: false, approved: true, paused: false },
    ]
  },
  {
    id: "2",
    title: "Fire Safety",
    assessments: [
      { id: "2-1", title: "Fire Evacuation Procedure", version: "v3.0", issueDate: "2024-03-05", area: "All Areas", riskLevel: "Medium", highlighted: false, approved: true, paused: false },
      { id: "2-2", title: "Electrical Safety Check", version: "v1.1", issueDate: "2024-04-20", area: "Server Room", riskLevel: "High", highlighted: false, approved: false, paused: true },
    ]
  },
]
  ...
  const addAssessmentToCategory = (categoryId: string) => {
    if (newAssessmentData.title.trim()) {
      const newAssessment = {
        ...
        area: newAssessmentData.area.trim() || "N/A",
        riskLevel: newAssessmentData.riskLevel,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: COLORS.textSecondary }}>
                Manage health, safety, and operational risk assessments
              </p>
            </div>
          </div>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={newAssessmentData.area}
                              onChange={(e) => setNewAssessmentData(prev => ({ ...prev, area: e.target.value }))}
                          ...
                          <div>
                            ...
                            <select
                              value={newAssessmentData.riskLevel}
                              onChange={(e) => setNewAssessmentData(prev => ({ ...prev, riskLevel: e.target.value }))}
                              className="w-full px-4 py-2.5 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500"
                              style={{ borderColor: COLORS.border }}
                            >
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex gap-4 text-sm mt-1.5" style={{ color: COLORS.textSecondary }}>
                                ...
                                <span className="flex items-center gap-1">
                                  <span className="font-medium">Area:</span> {assessment.area}
                                </span>
                                <span className="flex items-center gap-1">
                                  <span className="font-medium">Risk:</span>
                                  <span className={`px-2 py-0.5 rounded text-xs ml-1 ${assessment.riskLevel === 'High' || assessment.riskLevel === 'Critical'
