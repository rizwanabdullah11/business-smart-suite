...
export default function NewCOSHHPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // TODO: Implement API call to create COSHH assessment
    console.log({
      title,
      version,
      location,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-sm mb-6" style={{ color: COLORS.textSecondary }}>
              Create a new COSHH assessment document
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  <option value="1">Cleaning Materials</option>
                  <option value="2">Production Chemicals</option>
                </select>
              </div>
