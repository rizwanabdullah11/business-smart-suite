...
const initialCategories = [
  {
    ...
    items: [
      { id: "1-1", title: "CNC Machine 01", type: "Preventive", date: "2024-03-15", status: "Scheduled", technician: "Mike Ross", highlighted: true, approved: true, paused: false },
      { id: "1-2", title: "Conveyor Belt A", type: "Corrective", date: "2024-02-10", status: "Completed", technician: "Harvey Specter", highlighted: false, approved: true, paused: false },
    ]
  },
  {
    id: "2",
    ...
    items: [
      { id: "2-1", title: "HVAC System - Office", type: "Preventive", date: "2024-04-01", status: "Scheduled", technician: "External Vendor", highlighted: false, approved: true, paused: false },
    ]
  },
]
  ...
  const addItemToCategory = (categoryId: string) => {
    if (newItemData.title.trim()) {
      const newItem = {
        ...
        technician: newItemData.technician.trim() || "TBD",
          ...
          >
            ...
            <div className="flex gap-3">
              <input
                ...
                placeholder="Enter category name (e.g. Vehicles, Safety Equip)..."
                  ...
                  <div className="p-5">
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={newItemData.technician}
                              onChange={(e) => setNewItemData(prev => ({ ...prev, technician: e.target.value }))}
                    ...
                    {sortedItems.length === 0 ? (
                      <div className="text-center py-12">
                        <Wrench className="w-12 h-12 mx-auto mb-3" style={{ color: COLORS.textLight }} />
                        <p className="font-medium" style={{ color: COLORS.textSecondary }}>No maintenance records in this category</p>
                      </div>
                    ) : (
                        ...
                        {sortedItems.map((item) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 ml-4">
                              ...
                              <div className="flex items-center gap-1">
                                <Link href={`/maintenance/${item.id}/edit`}><button className="p-2 rounded-lg hover:scale-105" style={{ background: "#DBEAFE", color: "#1E40AF" }}><Edit className="w-4 h-4" /></button></Link>
