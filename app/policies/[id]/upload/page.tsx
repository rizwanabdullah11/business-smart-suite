...
export default function UploadPolicyPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  const [selectedFile, setSelectedFile] = useState<File | null>(null)
  const detailHref = id ? `/task/policies/${id}?back=${encodeURIComponent("/policies")}` : "/policies"
